    ...
    <section className="py-20 px-4 bg-slate-900">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-0.5 bg-green-500/20 transform md:-translate-x-1/2" />
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-green-500 rounded-full transform -translate-x-[7px] md:-translate-x-1/2 mt-6 shadow-lg shadow-green-500/50" />

                {/* Content */}
                <div className="md:w-1/2 pl-8 md:pl-0">
                  <div className={`${index % 2 === 0 ? "md:text-right md:pr-12" : "md:pl-12"}`}>
                    <div className="inline-flex items-center gap-2 bg-green-500/10 text-green-400 px-3 py-1 rounded-full text-sm mb-3 border border-green-500/20">
